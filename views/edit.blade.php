        ...
        <div>
            <form method="post" action="{{ route('update',$ourPost->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{ $ourPost->name }}" aria-describedby="nameHelp">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="description" name="description" value="{{ $ourPost->description }}">
                    @error('description')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
